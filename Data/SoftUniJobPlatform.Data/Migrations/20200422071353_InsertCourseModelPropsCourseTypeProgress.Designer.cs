...
namespace SoftUniJobPlatform.Data.Migrations
{
    ...
    [Migration("20200422071353_InsertCourseModelPropsCourseTypeProgress")]
    partial class InsertCourseModelPropsCourseTypeProgress
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoftUniJobPlatform.Data.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("SoftUniJobPlatform.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SoftUniJobPlatform.Data.Models.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SoftUniJobPlatform.Data.Models.Skill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SoftUniJobPlatform.Data.Models.Student", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SoftUniJobPlatform.Data.Models.UsersSkill", b =>
                {
                    b.Property<string>("ApplicationUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("SoftUniJobPlatform.Data.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SoftUniJobPlatform.Data.Models.StudentCourse", b =>
                {
                    ...
                    b.HasOne("SoftUniJobPlatform.Data.Models.Course", "Course")
            ...
            modelBuilder.Entity("SoftUniJobPlatform.Data.Models.StudentJob", b =>
                {
                    ...
                    b.HasOne("SoftUniJobPlatform.Data.Models.Job", "Job")
                        .WithMany("Candidates")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SoftUniJobPlatform.Data.Models.UsersSkill", b =>
                {
                    ...
                    b.HasOne("SoftUniJobPlatform.Data.Models.Skill", "Skill")
                        .WithMany("UsersSkills")
